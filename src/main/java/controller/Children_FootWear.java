...
@ManagedBean(name = "chFootWear")

public class Children_FootWear {


    public ArrayList<Children> getFootwearProduct()
    {
        ...
        try{
            ...
            String sql="select product_name,product_id,price,product_size from product_list where gender_id=" +
                    ...
                    "and categories_id=(select categories_id from categories where categories_name='Footwear')";
